...
const profileEditFormButton = document.querySelector("#profileModal__button");
const cardTemplate =
...
profileEditFormButton.addEventListener("submit", (e) => {
  e.preventDefault();
...
cardModalSave.addEventListener("submit", (e) => {
